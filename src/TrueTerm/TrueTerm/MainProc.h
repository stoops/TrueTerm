...
@property (strong) NSNumber *newl;
@property (strong) NSNumber *swap;
...
#define ANSI_SNOP (0 <<  0)
#define ANSI_SBEG (1 <<  0)
#define ANSI_SARG (1 <<  1)
#define ANSI_SDAT (1 <<  2)
#define ANSI_SMOR (1 <<  3)
#define ANSI_SEND (1 <<  4)
